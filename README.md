...
The following improvements are cherry-picked from [hookify-plus](https://github.com/adrozdenko/hookify-plus) (adrozdenko):
...
Original plugin by Anthropic. Bug fixes and cache by Chris Irving. Cherry-picks from [hookify-plus](https://github.com/adrozdenko/hookify-plus).
